namespace WindowAPI.winuser.CallBack
{
    public static class CallBacks
    {
        ...
        public delegate int DLGPROC(IntPtr unnamedParam1, uint unnamedParam2, IntPtr unnamedParam3, IntPtr unnamedParam4);
        ...
        public delegate bool GRAYSTRINGPROC(IntPtr unnamedParam1, IntPtr unnamedParam2, int unnamedParam3);
        ...
        public delegate bool MONITORENUMPROC(IntPtr unnamedParam1, IntPtr unnamedParam2, int unnamedParam3, IntPtr unnamedParam4);
        ...
        public delegate bool PROPENUMPROCA(IntPtr unnamedParam1, string unnamedParam2, IntPtr unnamedParam3);
        ...
        public delegate bool PROPENUMPROCEXA(IntPtr unnamedParam1, string unnamedParam2, IntPtr unnamedParam3, int unnamedParam4);

        /// <summary>
        ///Application-defined callback function used with the EnumPropsEx function. The function receives property entries from a window's property list. The PROPENUMPROCEX type defines a pointer to this callback function. PropEnumProcEx is a placeholder for the application-defined function name.
        /// </summary>

        public delegate bool PROPENUMPROCEXW(IntPtr unnamedParam1, string unnamedParam2, IntPtr unnamedParam3, int unnamedParam4);

        /// <summary>
        ///An application-defined callback function used with the EnumProps function. The function receives property entries from a window's property list. The PROPENUMPROC type defines a pointer to this callback function. PropEnumProc is a placeholder for the application-defined function name.
        /// </summary>

        public delegate bool PROPENUMPROCW(IntPtr unnamedParam1, string unnamedParam2, IntPtr unnamedParam3);
        ...
        public delegate void SENDASYNCPROC(IntPtr unnamedParam1, uint unnamedParam2, int unnamedParam3, IntPtr unnamedParam4);
        ...
        public delegate void TIMERPROC(IntPtr unnamedParam1, uint unnamedParam2, int unnamedParam3, uint unnamedParam4);
        ...
        public delegate IntPtr WNDPROC(IntPtr unnamedParam1, uint unnamedParam2, IntPtr unnamedParam3, IntPtr unnamedParam4);
    }
}
