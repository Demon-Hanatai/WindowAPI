namespace WindowAPI.olecl.h
{
    public static class Functions
    {
        ...
        public static extern nint /*UKNOW:NEED_FIX*/ DllRegisterServer();
        ...
        [DllImport("Ole32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ DllUnregisterServer();
        ...
        /// <param name="lplpvObj"></param>

        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleCreateFontIndirect(nint /*UKNOW:NEED_FIX*/ lpFontDesc, nint /*UKNOW:NEED_FIX*/ riid, out nint lplpvObj);
        ...
        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleCreatePictureIndirect(nint /*UKNOW:NEED_FIX*/ lpPictDesc, nint /*UKNOW:NEED_FIX*/ riid, bool fOwn, out nint lplpvObj);
        ...
        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleCreatePropertyFrame(nint hwndOwner, uint x, uint y, nint /*UKNOW:NEED_FIX*/ lpszCaption, uint cObjects, nint /*UKNOW:NEED_FIX*/ ppUnk, uint cPages, nint /*UKNOW:NEED_FIX*/ pPageClsID, nint /*UKNOW:NEED_FIX*/ lcid, uint dwReserved, nint pvReserved);
        ...
        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleCreatePropertyFrameIndirect(nint /*UKNOW:NEED_FIX*/ lpParams);
        ...
        [DllImport("Oleaut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern void OleIconToCursor(nint hinstExe, nint hIcon);
        ...
        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleLoadPicture(nint /*UKNOW:NEED_FIX*/ lpstream, int lSize, bool fRunmode, nint /*UKNOW:NEED_FIX*/ riid, out nint lplpvObj);
        ...
        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleLoadPictureEx(nint /*UKNOW:NEED_FIX*/ lpstream, int lSize, bool fRunmode, nint /*UKNOW:NEED_FIX*/ riid, uint xSizeDesired, uint ySizeDesired, uint dwFlags, out nint lplpvObj);
        ...
        /// <param name="lplpdispPicture"></param>

        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleLoadPictureFile(object varFileName, out nint lplpdispPicture);
        ...
        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleLoadPictureFileEx(object varFileName, uint xSizeDesired, uint ySizeDesired, uint dwFlags, out nint lplpdispPicture);
        ...
        /// <param name="ppvRet"></param>

        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleLoadPicturePath(nint /*UKNOW:NEED_FIX*/ szURLorPath, nint /*UKNOW:NEED_FIX*/ punkCaller, uint dwReserved, nint /*UKNOW:NEED_FIX*/ clrReserved, nint /*UKNOW:NEED_FIX*/ riid, out nint ppvRet);
        ...
        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleSavePictureFile(nint lpdispPicture, nint /*UKNOW:NEED_FIX*/ bstrFileName);
        ...
        /// <param name="lpcolorref"></param>

        [DllImport("OleAut32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        public static extern nint /*UKNOW:NEED_FIX*/ OleTranslateColor(nint /*UKNOW:NEED_FIX*/ clr, nint /*UKNOW:NEED_FIX*/ hpal, out nint /*UKNOW:NEED_FIX*/ lpcolorref);
